...
salary_57 <- salaries[salaries$Employee =="Employee 57","salaries_2018"]
...
biggest_raise <- salaries[salaries$change == highest_raise, "Employee"]

# What was the largest decrease in salaries between the two years?
biggest_decrease <- min(salaries$change)

# What was the name of the employee who recieved largest decrease in salary?
highest_decrease <- salaries[salaries$change == biggest_decrease, "Employee"]
